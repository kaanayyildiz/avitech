  ...
  return (
    <>
        ...
        <div className="p-5">
          <div className="grid md:grid-cols-3 gap-8 md:gap-20 text-sm">
            <div className="flex flex-col ">
              <span className="text-gray-900">{t("contentWhoWeAreTitle")}</span>
              <p className="text-gray-500 pt-3 ">{t("contentWhoWeAre")}</p>
            </div>
            <div>
              <span className="text-gray-900">
                {t("contentOurVisionTitle")}
              </span>
              <p className="text-gray-500 pt-3 ">{t("contentOurVision")}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full mx-auto 2xl:max-w-[90rem] p-6 text-gray-900">
        ...
        <div className="p-5 mx-auto md:grid md:grid-cols-2" id="contact-us">
          <div className="">
            <h1 className="text-sm">{t("contentContactUsTitle")}</h1>
            <h2 className="font-bold text-2xl md:text-4xl">
              {t("contentContactUsHead")}
            </h2>
            <p className="text-gray-500 pt-3">{t("contentContactUsText")}</p>
          </div>
